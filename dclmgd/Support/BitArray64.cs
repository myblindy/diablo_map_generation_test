...
namespace dclmgd.Support
{
    ...
    public class BitArray64 : IEnumerable<bool>
    {
        ...
        public BitArray64(int length, bool initialValue = false)
        {
            Length = length;
        ...
        public BitArray64 SetAllBits(bool value)
        {
        ...
        /// <returns>The instance of the modified bitmap.</returns>
        public BitArray64 SetBit(int index, bool value)
        {
            if (!IsValidIndex(index))
                throw new ArgumentOutOfRangeException(nameof(index));
        ...
        public BitArray64 Union(BitArray64 bitmap)
        {
        ...
        /// <returns>A reference to this instance.</returns>
        public BitArray64 Intersect(BitArray64 bitmap)
        {
            if (Length != bitmap.Length)
        ...
        /// <returns>A reference to this instance.</returns>
        public BitArray64 SetRange(int start, int end, bool value)
        {
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => obj is BitArray64 bitmap && bits.SequenceEqual(bitmap.bits);

        /// <inheritdoc/>
        public override int GetHashCode()
        {
            var hashCode = 671604886;
            hashCode = bits.Take(Length)
